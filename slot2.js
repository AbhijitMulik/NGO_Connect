document.addEventListener("DOMContentLoaded", function () {
  ...
  const ngoNames = {
      children: ['Vatsalya Trust', 'Baalanand', 'Catalyst for Social Axtion', 'Prerna', 'Shraddhanand Organization'],
      elderly: ['Adharwad Trust', 'ADAPT-Able Disable All People Together', 'Kamla Mheta Donar Blind School'],
